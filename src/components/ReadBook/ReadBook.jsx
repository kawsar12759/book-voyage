...
const ReadBook = ({ book }) => {
    ...
    return (
        <div className="lg:flex border p-3 sm:p-5 rounded-lg">
                ...
                <div className="w-full">
                    ...
                    <div className="md:flex md:items-center mb-3">
                        <div className="flex sm:items-center mb-3 md:mb-0">
                            <p className="text-base font-bold text-[#131313] mr-3 sm:mr-5">Tag</p>
                            <div className="flex flex-wrap gap-2">
                                {
                                    tags.map((tag, idx) => <p className="text-[#23BE0A] bg-custom-green  sm:mr-3 px-3 sm:px-4 py-1 rounded-full font-medium" key={idx}>{tag}</p>)
                                }
                            </div>
                        </div>
                    ...
                    <div className="md:flex md:items-center mb-4 font-normal">
                        <div className="flex items-center mb-3 md:mb-0">
                            <IoPeopleOutline className="text-base text-black60 mr-2 font-medium" />
                            <p className="text-base text-black60 md:mr-7">Publisher: {publisher}</p>
                        </div>
                        <div className="flex items-center">
                    ...
                    <div className="md:flex items-center text-xs sm:text-base font-normal">
                        <div className="md:flex">
                            <div className="mb-4 md:mb-0 mr-3 bg-category-background px-4  py-2 rounded-full">
                                <p className="text-[#328EFF]">Category: {category}</p>
                            </div>
                            <div className="mb-4 md:mb-0 mr-3 bg-rating-background px-4 py-2 rounded-full">
